    ...
    try:
        ...
        for key in device_keys:
            ...
            if device_data:
                ...
                # Check if device has validation data and is Fortinet
                if "validation" in device_json:
                    validation_data = device_json["validation"]
                    if not validation_data.get('vendor') == 'Fortinet':
                        continue
        ...
        return fortinet_data, fortinet_details
...
try:
    ...
    fortinet_data, fortinet_details = load_validation_data()
