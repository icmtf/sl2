    ...
    try:
        ...
        for key in device_keys:
            ...
            if device_data:
                ...
                # Check if device has validation data and is Cisco
                if "validation" in device_json:
                    validation_data = device_json["validation"]
                    if not validation_data.get('vendor') == 'Cisco':
                        continue
        ...
        return cisco_data, cisco_details
...
try:
    ...
    cisco_data, cisco_details = load_validation_data()
